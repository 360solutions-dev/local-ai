...
import { DownloadProvider } from "@/lib/download-provider";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${outfit.variable} ${jetbrainsMono.variable}`} data-scroll-behavior="smooth" suppressHydrationWarning>
      ...
      <body style={{ margin: 0 }}>
        <QueryProvider><LanguageProvider><DownloadProvider>{children}<UpdateNotificationBanner /></DownloadProvider></LanguageProvider></QueryProvider>
      </body>
    </html>
  );
}

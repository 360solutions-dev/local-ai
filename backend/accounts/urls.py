...
urlpatterns = [
    ...
    path("recovery/verify/", views.RecoveryVerifyView.as_view(), name="accounts-recovery-verify"),
    path("recovery/regenerate/", views.RegenerateRecoveryCodeView.as_view(), name="accounts-recovery-regenerate"),
]

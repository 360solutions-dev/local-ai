...
urlpatterns = [
    ...
    path("ollama/switch-engine/", views.SwitchOllamaEngineView.as_view(), name="ollama-switch-engine"),
    path("providers/test/", views.ProviderTestView.as_view(), name="provider-test"),
    path("connectivity/", views.ConnectivityView.as_view(), name="connectivity"),
